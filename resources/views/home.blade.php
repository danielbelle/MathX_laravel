      ...
      <div class="container border border-primary rounded-3 p-5">
        ...
        <div class="row gap-5">
          ...
          <div class="col">
            ...
            <div class="form-check mb-3">
              <input class="form-check-input" type="checkbox" id="check_multiplication" name="check_multiplication"
                checked>
      ...
      <div class="container">
        <div class="row">
          <div class="alert alert-danger text-center mt-3">
            Por favor selecione pelo menos uma operação. As parcelas devem ser números entre 0 a 999. O número de
